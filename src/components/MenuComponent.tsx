      ...
      <nav className="bg-gradient-to-r from-green-200 via-blue-300 to-yellow-100 border-b shadow-md">
        <div className="max-w-screen-xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <ul className="hidden md:flex space-x-8 text-gray-1000 font-medium">
            ...
            <li className="relative group">
              ...
              <ul className="absolute hidden group-hover:block bg-white border shadow-md py-2 rounded z-10">
                <li className="block px-4 py-2 hover:bg-gray-100">
                  <Link href="/guanacaste">Guanacaste</Link>
                </li>
                <li className="block px-4 py-2 hover:bg-gray-100">
                  <Link href="/alajuela">Alajuela</Link>
                </li>
              </ul>
            </li>
            ...
            <Link href="/contacto">
              <button
                type="button"
                className="text-white bg-emerald-300 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              >
                Contacto
              </button>
            </Link>
        ...
        {isOpen && (
          <ul className="md:hidden px-4 pb-4 space-y-2 text-gray-700 font-medium">
            ...
            <li>
              <button className="w-full text-left" onClick={() => setIsReportOpen(!isReportOpen)}>
                Atracciones {isReportOpen ? '▲' : '▼'}
              </button>
              {isReportOpen && (
            ...
            <li>
              <button className="w-full text-left" onClick={() => setIsReportOpen2(!isReportOpen2)}>
                Reportes {isReportOpen2 ? '▲' : '▼'}
              </button>
              {isReportOpen2 && (
                <ul className="pl-4 mt-1 space-y-1">
